...
extern int m_ttyset();
extern void m_ttyreset();
extern void m_resetflags();
extern void m_setflags();
extern int m_bitfile();

extern int m_getbordersize();
extern int m_dflbordersize();
extern int m_getdepth();
extern int m_gethostname();
extern int m_getscreensize();
extern char *m_getfontname();
extern int m_getfontsize();
extern int m_getfontid();
extern int m_getwindowsize();
extern int m_getwindowposition();
extern int m_getevent();
extern int m_localsrv();
extern int m_getpalette();
