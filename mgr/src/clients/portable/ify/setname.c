...
/* Both parameters are supplied at every call site: an omitted one is read
   from whatever the stack held, and err is what the program exits with. */
void
die(mesg, err)
     char *mesg;
     int err;
