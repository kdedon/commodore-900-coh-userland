...
struct icon msg_board = {"msg_board",1,0,0,0};
struct icon msg_note = {"msg_note",1,0,0,0};
struct icon msg_read = {"msg_read",1,0,0,0};
struct icon msg_none = {"msg_none",1,0,0,0};


void clean(), check_msgs(), download_icon();
