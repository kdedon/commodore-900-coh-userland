...
char *argv[];
{
  ...
  /* One literal: K&R cc0 does not concatenate adjacent string literals, so
     the four-part spelling leaves the array with no deducible size. */
  static char mousemenu[] = "|Start of file|Back 1 screen|Back 1/2 screen|Back 1 line|--------|Help|Edit file|Quit|--------|Fwd 1 line|Fwd 1/2 screen|Fwd 1 screen|End of file|g|b|u|k||h|v|q||j|d|f|G|";
