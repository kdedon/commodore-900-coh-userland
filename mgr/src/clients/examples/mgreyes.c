...
/*}}}  */
/*{{{  m_fcircleto*/
void m_fcircleto(bitmap, cx, cy, rx, ry)
int bitmap;
int cx;
int cy;
int rx;
...
/*}}}  */
/*{{{  mkeye*/
void mkeye(width, height, puiple)
int width;
int height;
int *puiple;
{
...
/*}}}  */
/*{{{  redraw*/
void redraw(my_width, my_height)
int my_width;
int my_height;
{
  m_clear();
...
/*}}}  */
/*{{{  set_puiple*/
void set_puiple(my_width, my_height, puiple, lx, ly, rx, ry)
int my_width;
int my_height;
int puiple;
int lx;
...
/*}}}  */
/*{{{  clr_puiple*/
void clr_puiple(my_width, my_height, puiple, lx, ly, rx, ry)
int my_width;
int my_height;
int puiple;
int lx;
...
/*}}}  */
/*{{{  puiple_pos*/
void puiple_pos(ex, ey, mx, my, nx, ny)
int ex;
int ey;
int mx;
int my;
