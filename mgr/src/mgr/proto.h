...
_PROTOTYPE( extern size_t fread, (char *_ptr, size_t _size, size_t _nmemb, FILE *_stream));
...
_PROTOTYPE( extern int memcmp, (const char *_s1, const char *_s2, size_t _len));
_PROTOTYPE( extern char *memcpy, (char *_dst, const char *_src, size_t _len));
_PROTOTYPE( extern char *memset, (char *_dst, int _uc, size_t _len));
#endif
#ifdef sun	/* needed for their FD_ZERO */
_PROTOTYPE( extern void bzero, (char *_dst, size_t _len));
#endif
