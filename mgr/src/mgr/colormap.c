...
static long int lightdiff(c0, c1)
unsigned int *c0;
unsigned int *c1;
{
 ...
 */
static
unsigned int rescale(col, oldmax, newmax)
unsigned int col;
unsigned int oldmax;
unsigned int newmax;
{
...
void findcolor(bp, co, r, g, b, maxi)
BITMAP *bp;
unsigned int *co;
unsigned int *r;
unsigned int *g;
