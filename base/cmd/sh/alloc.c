 ...
 *	notmem() answers whether the pointer is a block of the malloc arena
 *	that is in use, so a static string, an automatic variable and a block
 *	already freed are all left alone.
 */
sfree(cp)
char *cp;
{
