...
/*
 * These declarations and the first half of main() (through the mnttab
 * update loop) were lost to disc corruption in the recovered source and
 * have been reconstructed from disasm/umount.asm.  zmtab/zmnttab are the
 * all-zero images written over a table entry to clear it.
 */
struct	mtab	mtab;
