 ...
 */
#ifndef lint
static char rcsid[]= "$Id: rcsedit.c,v 4.8 89/05/01 15:12:35 narten Exp $ Purdue CS";
#endif
/**********************************************************************************
...
long editline; /*line counter in fedit; starts with 1, is always #lines+1   */
long linecorr; /*contains #adds - #deletes in each edit run.                */
               /*long, because a working file may hold more lines than a    */
               /*16-bit int can count                                       */
...
register long line; struct hshentry * delta;
