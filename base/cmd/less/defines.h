...
/* Generated Thu May  2 20:44:39 1991 CST by linstall. */
...
/*
 * REGCOMP is 1 if regular expressions are matched with the Spencer
 * regcomp()/regexec() pair (base/lib/regexp), which is what this
 * system supplies.
 */
#define	REGCOMP		1
