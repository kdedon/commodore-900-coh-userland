...
#if TERMIO
#include <termio.h>
	/* JPRadley added next five lines for SCO UNIX */
...
/*
 * tgoto() reads these when a cursor address needs a backspace or an
 * up-motion; libterm leaves them for the calling program to supply.
 */
char *UP;			/* Up one line */
char *BC;			/* Backspace */
