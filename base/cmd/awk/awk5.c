...
register NODE *n1, *n2;
{
	...
	/*
	 * The left operand is copied out before the right one is evaluated.
	 * evalstring() formats a numeric value into one static buffer and
	 * returns it, so evaluating n2 overwrites whatever it returned for
	 * n1: without the copy `x=12; y=34; print x y' prints 3434.
	 */
