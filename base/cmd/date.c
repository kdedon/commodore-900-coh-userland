...
char *s;
{
	...
	/*
	 * Two-digit years pivot at 70: 70..99 are 19xx, 00..69 are 20xx.
	 * Where no year digits were given, tm_year still holds what
	 * localtime() left, which is years since 1900 and so already 70 or
	 * more; that lands in the first arm and reproduces the year it came
	 * from.
	 */
	year = (tmp->tm_year >= 70 ? 1900 : 2000) + tmp->tm_year;
	/*
