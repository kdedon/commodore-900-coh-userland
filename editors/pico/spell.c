...
static char rcsid[] = "$Id: spell.c,v 4.4 1993/10/06 17:38:53 mikes Exp $";
#endif
/*
 * Program:	spell.c
 *
...
static char *spellhelp[] = {
  ...
  " ",
  "~\tSpell checking can be canceled at any time by typing ~^~C (~F~3)",
  "\tafter exiting help.",
  " ",
...
static char *pinespellhelp[] = {
  ...
  "\teach occurrence of the incorrect word is offered for replacement.",
  " ",
  "\tSpell checking can be canceled at any time by typing ^C (F3)",
  "\tafter exiting help.",
  " ",
  "End of Spell Check Help",
  " ",
