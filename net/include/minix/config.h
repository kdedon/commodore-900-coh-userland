...
#define Z8000             4	/* CHIP type for Commodore 900 (Z8001)      */
...
#ifdef Z8001			/* Commodore 900: Z8001, big-endian, 16-bit words */
#undef  CHIP
#define CHIP          Z8000
#undef  _WORD_SIZE
#define _WORD_SIZE        2
#undef  _EM_WSIZE		/* the ACK word-size predef the inet code assumes */
#define _EM_WSIZE         2	/* (used verbatim in CRAMPED, not just #if)   */
#endif
