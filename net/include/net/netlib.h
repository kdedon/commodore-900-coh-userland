...
/* libsocket (not Minix): bytes held for a socket that poll() cannot see,
 * because they are already off the reply FIFO.  See libsocket.c sockheld. */
_PROTOTYPE (int sockheld, (int fd) );
