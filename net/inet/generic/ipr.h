...
/* ARGS() is empty on this compiler (no prototypes), so nothing widens an
 * argument at the call: `timeout' and `preference' are 32 bits and must be
 * passed as such -- (time_t) and (i32_t) casts on anything narrower. */
