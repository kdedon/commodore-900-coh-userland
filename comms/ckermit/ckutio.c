...
#ifndef aegis
#ifndef XENIX
#include <sys/filsys.h>                   /* File information */
#endif /* xenix */
#endif /* aegis */
#endif /* provx1 */
...
#ifdef ANYBSD
#ifndef aegis
#include <fcntl.h>                      /* F_GETFL, used by ttclos() below */
#endif /* aegis */
#endif /* anybsd */
...
#ifndef V7
#ifndef BSD41
#include <time.h>                   /* Clock info (for break generation) */
#endif /* not bsd41 */
#endif /* not v7 */
#endif /* not provx1 */
#endif /* not uxiii */
...
ttoc(c) char c; {
    ...
    x = write(ttyfd,&cb,1);		/* Try to write the character. */
