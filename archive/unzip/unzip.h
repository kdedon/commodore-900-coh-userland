...
#  ifndef NOPROTO       /*  permission from the fine folks at Cray Research, */
...
int    extract_or_test         __( (void) );
int    extract_member        __( (void) );
 ...
 *  A slightly modified version is embedded within extract_or_test
