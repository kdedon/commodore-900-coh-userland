...
/* Tcl_HashTable SpriteCmds;  (dropped for ncurses port) */
short CrashX, CrashY;
int absDist;
short Cycle;
...
short SpriteNotInBounds(sprite)
SimSprite *sprite;
{
...
short GetDir(orgX, orgY, desX, desY)
int orgX;
int orgY;
int desX;
int desY;
...
int CheckSpriteCollision(s1, s2)
SimSprite *s1;
SimSprite *s2;
{
