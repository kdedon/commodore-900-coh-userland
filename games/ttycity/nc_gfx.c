 ...
 * power lines light.
 *
 * Every glyph table in this file, and the pictograms in uni_tile below, hold
 * UTF-8 byte sequences spelled as octal escapes: the source stays 7-bit so it
 * compiles under a native cc0, and the bytes written to the terminal are
 * unchanged.  The unicode mode itself is unavailable on this target
 * (MB_CUR_MAX is 1); the tables are what the C900 tile mode reindexes onto
 * loadable high-half codes. */
static char *road_gl[16] = {
  "\342\225\213 ", "\342\224\201\342\224\201", "\342\224\201 ", "\342\224\201\342\224\201", "\342\224\203 ", "\342\224\217\342\224\201", "\342\224\223 ", "\342\224\263\342\224\201",
  "\342\224\203 ", "\342\224\227\342\224\201", "\342\224\233 ", "\342\224\273\342\224\201", "\342\224\203 ", "\342\224\243\342\224\201", "\342\224\253 ", "\342\225\213\342\224\201"
};
static char *rail_gl[16] = {
  "\342\225\254 ", "\342\225\220\342\225\220", "\342\225\220 ", "\342\225\220\342\225\220", "\342\225\221 ", "\342\225\224\342\225\220", "\342\225\227 ", "\342\225\246\342\225\220",
  "\342\225\221 ", "\342\225\232\342\225\220", "\342\225\235 ", "\342\225\251\342\225\220", "\342\225\221 ", "\342\225\240\342\225\220", "\342\225\243 ", "\342\225\254\342\225\220"
};
static char *wire_gl[16] = {
  "\342\224\274 ", "\342\224\200\342\224\200", "\342\224\200 ", "\342\224\200\342\224\200", "\342\224\202 ", "\342\224\214\342\224\200", "\342\224\220 ", "\342\224\254\342\224\200",
  "\342\224\202 ", "\342\224\224\342\224\200", "\342\224\230 ", "\342\224\264\342\224\200", "\342\224\202 ", "\342\224\234\342\224\200", "\342\224\244 ", "\342\224\274\342\224\200"
};
...
int
nc_zone_den(t, builtBase, builtHi, dmod, vac)
int t;
int builtBase;
int builtHi;
int dmod;
...
/* zone-center icon by land value (GetCRVal 0..3); the top glyph (sunset /
 * bank) is reserved for zones at max value AND max density; industrial is
 * always the factory glyph */
static char *res_val[4] = { "\360\237\233\226", "\360\237\217\240", "\360\237\217\241", "\360\237\217\241" };
static char *com_val[4] = { "\360\237\217\252", "\360\237\217\254", "\360\237\217\242", "\360\237\217\242" };

/* braille terrain textures */
static char *dirt_tex[4]  = { "\342\240\220\342\240\204", "\342\240\240\342\240\202", "\342\240\204\342\240\220", "\342\240\202\342\240\240" };
static char *water_tex[4] = { "\342\243\200\342\243\200", "\342\240\244\342\240\244", "\342\243\200\342\240\244", "\342\240\244\342\243\200" };

/* quadrant-block debris */
static char *rubble_tex[4] = { "\342\226\232\342\226\236", "\342\226\236\342\226\226", "\342\226\231\342\226\230", "\342\226\227\342\226\232" };
...
static char *stad_gl[16] = {
  "\342\227\234\342\227\240", "\342\227\240\342\227\240", "\342\227\240\342\227\240", "\342\227\240\342\227\235",
  "( ", "  ", "  ", " )",
  "( ", "  ", "  ", " )",
  "\342\227\237\342\227\241", "\342\227\241\342\227\241", "\342\227\241\342\227\241", "\342\227\241\342\227\236"
};

/* police station (3x3 lot): dashed fence around the yard, officer at center */
static char *fence_gl[9] = {
  "\342\224\217\342\224\205", "\342\224\205\342\224\205", "\342\224\205\342\224\223",
  "\342\224\207 ", "  ", " \342\224\207",
  "\342\224\227\342\224\205", "\342\224\205\342\224\205", "\342\224\205\342\224\233"
};

static void
uni_tile(sy, sx, mx, my)
int sy;
int sx;
int mx;
int my;
{
  ...
  if (t == LIGHTNINGBOLT) {		/* unpowered zone blink */
    uput(sy, sx, "\342\232\241", COLOR_YELLOW, land, A_BOLD);
    return;
  }
  ...
  if (cls == 1) {
    if (t >= HTRFBASE) {				/* heavy traffic jam */
      uput(sy, sx, ((mx + my) & 1) ? "\360\237\232\227" : "\360\237\232\225", COLOR_WHITE, COLOR_BLACK, 0);
      return;
    }
  ...
  if (t >= RIVER && t <= LASTRIVEDGE) {
    if (t >= FIRSTRIVEDGE && (h % 13) == 0) {		/* a crab on the shore */
      uput(sy, sx, "\360\237\246\200", COLOR_RED, COLOR_BLUE, A_BOLD);
      return;
    }
    if ((h % 37) == 0) { uput(sy, sx, "\342\233\265", COLOR_WHITE, COLOR_BLUE, 0); return; }
    if ((h % 41) == 0) { uput(sy, sx, "\360\237\220\237", COLOR_CYAN,  COLOR_BLUE, 0); return; }
    uput(sy, sx, water_tex[h & 3], COLOR_CYAN, COLOR_BLUE, A_BOLD);
    return;
  }
  if (t >= TREEBASE && t < WOODS2) {
    uput(sy, sx, ((h % 7) == 0) ? "\360\237\214\263" : "\360\237\214\262", COLOR_BLACK, COLOR_GREEN, 0);
    return;
  }
  if (t >= WOODS2 && t <= WOODS5) {			/* user-placed park */
    uput(sy, sx, "\360\237\214\263", COLOR_BLACK, COLOR_GREEN, 0);
    return;
  }
  if (t >= RUBBLE && t <= LASTRUBBLE) {
    if ((h % 5) == 0) uput(sy, sx, "\360\237\247\261", COLOR_BLACK, land, 0);
    else              uput(sy, sx, rubble_tex[h & 3], COLOR_BLACK, land, 0);
    return;
  }
  if (t >= FLOOD && t <= LASTFLOOD) {
    uput(sy, sx, "\360\237\214\212", COLOR_WHITE, COLOR_CYAN, A_BOLD);
    return;
  }
  if (t == RADTILE) {
    uput(sy, sx, "\342\230\242 ", COLOR_YELLOW, COLOR_MAGENTA, A_BOLD);
    return;
  }
  if (t >= FIREBASE && t <= LASTFIRE) {
    uput(sy, sx, "\360\237\224\245", COLOR_YELLOW, COLOR_RED, A_BOLD);
    return;
  }

  /* ---- city services (3x3 lots; the exact center tile is the landmark) ---- */
  if (t >= HOSPITAL - 4 && t <= HOSPITAL + 4) {
    if (t == HOSPITAL) uput(sy, sx, "\360\237\217\245", COLOR_WHITE, COLOR_RED, A_BOLD);
    else               uput(sy, sx, "\342\226\222\342\226\222", COLOR_WHITE, COLOR_RED, 0);
    return;
  }
  if (t >= CHURCH - 4 && t <= CHURCH + 4) {
    if (t == CHURCH) uput(sy, sx, "\342\233\252", COLOR_BLACK, COLOR_CYAN, 0);
    else             uput(sy, sx, "\342\226\222\342\226\222", COLOR_BLACK, COLOR_CYAN, 0);
    return;
  }
   ...
   * still-vacant lot cells stay light-shade ---- */
  if (t >= RESBASE && t < COMBASE) {
    ...
    if (den >= 0) {
      ...
      ico = (den == 3 && val == 3) ? "\360\237\214\207" : res_val[val];
      if (vac) uput(sy, sx, "\342\226\221\342\226\221", COLOR_BLACK, COLOR_CYAN, 0);
      else     uput(sy, sx, ico, COLOR_BLACK, COLOR_CYAN, 0);
      return;
    }
    if (t <= RESBASE + 8) {				/* empty designated lot */
      if (center) uput(sy, sx, "\360\237\217\227", COLOR_YELLOW, COLOR_CYAN, A_BOLD);
      else        uput(sy, sx, "\342\226\221\342\226\221", COLOR_BLACK, COLOR_CYAN, 0);
      return;
    }
    uput(sy, sx, "\342\226\232 ", COLOR_BLACK, COLOR_CYAN, 0);	/* stray tile */
    return;
  }
  if (t >= COMBASE && t < INDBASE) {
    ...
    if (den >= 0) {
      ...
      ico = (den == 4 && val == 3) ? "\360\237\217\246" : com_val[val];
      if (vac) uput(sy, sx, "\342\226\221\342\226\221", COLOR_WHITE, COLOR_BLUE, 0);
      else     uput(sy, sx, ico, COLOR_WHITE, COLOR_BLUE, A_BOLD);
      return;
    }
    if (t <= COMBASE + 8) {
      if (center) uput(sy, sx, "\360\237\217\227", COLOR_YELLOW, COLOR_BLUE, A_BOLD);
      else        uput(sy, sx, "\342\226\221\342\226\221", COLOR_WHITE, COLOR_BLUE, 0);
      return;
    }
    uput(sy, sx, "\342\226\232 ", COLOR_WHITE, COLOR_BLUE, A_BOLD);
    return;
  }
  if (t >= INDBASE && t < PORTBASE) {
    den = nc_zone_den(t, IZB - 4, PORTBASE - 1, 4, &vac);
    if (den >= 0) {
      if (vac) uput(sy, sx, "\342\226\221\342\226\221", COLOR_YELLOW, COLOR_MAGENTA, 0);
      else     uput(sy, sx, "\360\237\217\255", COLOR_YELLOW, COLOR_MAGENTA, A_BOLD);
      return;
    }
    if (t <= INDBASE + 8) {
      if (center) uput(sy, sx, "\360\237\217\227", COLOR_YELLOW, COLOR_MAGENTA, A_BOLD);
      else        uput(sy, sx, "\342\226\221\342\226\221", COLOR_YELLOW, COLOR_MAGENTA, 0);
      return;
    }
    uput(sy, sx, "\342\226\232 ", COLOR_YELLOW, COLOR_MAGENTA, A_BOLD);
    return;
  }

  /* ---- big buildings (center tile carries ZONEBIT) ---- */
  if (t >= PORTBASE && t <= LASTPORT) {			/* seaport */
    if (center) uput(sy, sx, "\342\232\223", COLOR_WHITE, COLOR_BLUE, A_BOLD);
    else        uput(sy, sx, "\360\237\256\225\360\237\256\225", COLOR_WHITE, COLOR_BLUE, 0);	/* containers */
    return;
  }
  if (t >= RADAR0 && t <= RADAR7) {			/* airport tower (anim) */
    uput(sy, sx, "\360\237\223\241", COLOR_BLACK, COLOR_WHITE, 0);
    return;
  }
  if (t >= AIRPORTBASE && t < COALBASE) {		/* airport (6x6) */
    if (center) uput(sy, sx, "\360\237\233\253", COLOR_BLACK, COLOR_WHITE, 0);
    else        uput(sy, sx, "\342\226\221\342\226\221", COLOR_BLACK, COLOR_WHITE, 0);   /* tarmac */
    return;
  }
  if (t >= COALBASE && t <= LASTPOWERPLANT) {		/* coal power */
    if (center) uput(sy, sx, "\360\237\224\214", COLOR_WHITE, COLOR_RED, A_BOLD);
    else        uput(sy, sx, "\342\226\222\342\226\222", COLOR_WHITE, COLOR_RED, 0);
    return;
  }
  if (t >= FIRESTBASE && t < POLICESTBASE) {		/* fire station */
    if (center) uput(sy, sx, "\360\237\232\222", COLOR_WHITE, COLOR_RED, A_BOLD);
    else        uput(sy, sx, "\342\226\222\342\226\222", COLOR_WHITE, COLOR_RED, 0);
    return;
  }
  if (t >= POLICESTBASE && t < STADIUMBASE) {		/* police station */
    if (center) uput(sy, sx, "\360\237\221\256", COLOR_WHITE, COLOR_BLUE, A_BOLD);
    else        uput(sy, sx, fence_gl[(t - POLICESTBASE) % 9],
		     COLOR_WHITE, COLOR_BLUE, A_BOLD);
    return;
  }
  if (t >= FOOTBALLGAME1 && t <= FOOTBALLGAME2 + 7) {	/* game day (anim) */
    uput(sy, sx, "\360\237\217\210", COLOR_WHITE, COLOR_GREEN, 0);
    return;
  }
  if (t >= STADIUMBASE && t < NUCLEARBASE) {		/* stadium */
    if (center) uput(sy, sx, (t >= FULLSTADIUM) ? "\360\237\217\210" : "\342\232\275",
  ...
  if (t >= NUCLEARBASE && t <= LASTZONE) {		/* nuclear power */
    if (center) uput(sy, sx, "\342\230\242 ", COLOR_WHITE, COLOR_GREEN, A_BOLD);
    else        uput(sy, sx, "\342\226\222\342\226\222", COLOR_BLACK, COLOR_GREEN, 0);
    return;
  }

  /* ---- animation / oddball tiles ---- */
  if ((t >= HBRDG0 && t <= HBRDG3) || (t >= VBRDG0 && t <= VBRDG3)) {
    uput(sy, sx, "\360\237\214\211", COLOR_WHITE, COLOR_BLUE, 0);	/* open drawbridge */
    return;
  }
  if (t >= FOUNTAIN && t <= INDBASE2) {
    uput(sy, sx, "\342\233\262", COLOR_BLACK, COLOR_GREEN, 0);
    return;
  }
  if (t >= TINYEXP && t <= LASTTINYEXP) {
    uput(sy, sx, "\360\237\222\245", COLOR_YELLOW, COLOR_RED, A_BOLD);
    return;
  }
  if (t >= SMOKEBASE && t < TINYEXP) {
    uput(sy, sx, "\360\237\222\250", COLOR_WHITE, land, 0);
    return;
  }
  if (t >= COALSMOKE1 && t <= COALSMOKE4 + 3) {
    uput(sy, sx, "\360\237\222\250", COLOR_WHITE, COLOR_RED, 0);
    return;
  }

  uput(sy, sx, "\342\226\222\342\226\222", COLOR_WHITE, land, 0);		/* unknown tile */
}

/* moving objects: THE toys */
static void
uni_sprite(sy, sx, type)
int sy;
int sx;
int type;
{
  ...
  switch (type) {
  case TRA: s = "\360\237\232\202"; break;		/* train      */
  case COP: s = "\360\237\232\201"; break;		/* helicopter */
  case AIR: s = "\360\237\233\253"; break;		/* airplane   */
  case SHI: s = "\360\237\232\242"; break;		/* ship       */
  case GOD: s = "\360\237\246\226"; break;		/* monster    */
  case TOR: s = "\360\237\214\200"; break;		/* tornado    */
  case EXP: s = "\360\237\222\245"; break;		/* explosion  */
  case BUS: s = "\360\237\232\214"; break;		/* bus        */
  default:  s = "\342\235\223"; break;
  }
 ...
 * dense+bold. */
static chtype
as_zone(t, raw, letter, emptyBase, builtBase, builtHi, dmod)
int t;
int raw;
int letter;
int emptyBase;
