...
#% reject ^Panic:
#
# THE NARRATIVE IS IN `#' LINES, NOT TYPED `:' ONES.  The emulator queues only
# 8192 scripted bytes and this file types close to that without them; typed,
# they took it to 22,000 and the run stopped being typed mid-comment at byte
# 8192, waiting on a prompt for ever.  emu-run.sh now refuses such a script.
#
# THE RUN ENDS ON THE DONE MARK ALONE: park counts host loops, not guest time,
# and would end the ten-minute hold below as a hang.
#% stop mark
#
